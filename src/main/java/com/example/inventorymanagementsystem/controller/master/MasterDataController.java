...
public class MasterDataController {
    ...
    @Operation(summary = "Get all types of resources")
    ...
    @Operation(summary = "Get the resource type by resource id")
    ...
    @Operation(summary = "Get all the classification of resources")
    ...
    @Operation(summary = "Get the resource class by resource id")
    ...
    @Operation(summary = "Get all the status for resources")
    ...
    @Operation(summary = "Get the status of resources by resource id")
    ...
    @Operation(summary = "Create new resource class")
    ...
    @Operation(summary = "Create new resource status")
